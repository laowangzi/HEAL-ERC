...
def weight_calculate():
    #The correspongding weight is the sample num in the training set 
    res = [1.0, 1.3892, 3.8699, 2.8197, 4.5216, 2.3611, 3.3711]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', type=float, default=8e-5, metavar='LR', help='learning rate')
    parser.add_argument('--l2', type=float, default=1e-6, metavar='L2', help='L2 regularization weight')
    parser.add_argument('--dropout', type=float, default=0.5, metavar='dropout', help='dropout rate')
    parser.add_argument('--D_m', type=int, default=512, metavar='hidden', help='hidden dimension')
    parser.add_argument('--n_layers', type=int, default=2, metavar='n_layers', help='Transformer layers num')
    parser.add_argument('--n_layers_rnn', type=int, default=1, metavar='n_layers_rnn', help='RNN layers num')
    parser.add_argument('--heads', type=int, default=16, metavar='heads', help='attention heads')
    ...
    parser.add_argument('--dim_feedforward', type=float, default=2, help='dim_feedforward of Transformer FFN')
    parser.add_argument('--epochs', type=int, default=45, metavar='E', help='number of epochs')
    ...
    dataset = './data/EMORYNLP/emorynlp_features_roberta.pkl'
    ...
    #   Save the best performance according to valid set f1 score
        ...
        if best_test_f1 == None or test_fscore > best_test_f1:
